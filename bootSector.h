...
// Define macros for the number of elements in each field
 ...
 *
 * @param[in] rootDirAddress Pointer to store the calculated root directory address.
 ...
 *
 * @param[in] bs Pointer to the BootSector structure.
 ...
 *
 * @param[in] file           A pointer to the opened FAT file system image.
 * @param[in] rootDirAddress A pointer to store the calculated Root Directory address.
 ...
 *
 * @param[in] file       A pointer to the opened FAT file system image.
 * @param[in] bootSector A pointer to the Boot Sector structure to store the read data.
